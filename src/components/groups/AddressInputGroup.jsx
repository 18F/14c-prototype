...
//let AddressInputGroup = React.createClass({
//  propTypes: {
...
//        <TextInput
//          id={`${this.props.id}-address-1`}
//          name={`${this.props.name}-address-1`}
//          label="Street address 1"
//        />
//        {
//        /*
//          <label htmlFor={`${this.props.id}-address-1`}>Street address 1</label>
//          <input type="text" id={`${this.props.id}-address-1`} name={`${this.props.name}-address-1`} />
//        */
//        }
//        <TextInput
//          id={`${this.props.id}-address-2`}
//          name={`${this.props.name}-address-2`}
//          label="Street address 2 (optional)"
//        />
//        {
//        /*
//          <label htmlFor={`${this.props.id}-address-2`}>Street address 2</label>
//          <input type="text" id={`${this.props.id}-address-2`} name={`${this.props.name}-address-2`} />
//        */
//        }
//        <div>
...
//            {
//            /*
//              <label htmlFor={`${this.props.id}-city`}>City</label>
//              <input type="text" id={`${this.props.id}-city`} name={`${this.props.name}-city`} />
//            */
//            }
//          </div>
//          <div className="usa-input-grid usa-input-grid-small">
//            <label htmlFor={`${this.props.id}-state`}>State</label>
//            <select id={`${this.props.id}-state`} name={`${this.props.name}-state`}>
//              <option value=""></option>
...
//          </div>
//        </div>
//        <label htmlFor={`${this.props.id}-zip`}>ZIP</label>
//        <input type="text" className="usa-input-medium" id={`${this.props.id}-zip`} name={`${this.props.name}-zip`} pattern="[\d]{5}(-[\d]{4})?" data-grouplength="5,4" data-delimiter="-" data-politespace="" />
//      </fieldset>
//    );
//  }
//});
